...
public class Model {
  ...
  //instance variables, a list of dragons and a list of viewers
  ...
  /**
   * iterate through the list and change the iteration level
   * of all the dragon inside the list
   * @param ii an int type level of iteration
   */ 
  public void changeAllIteration(int ii){
    java.util.Iterator<Dragon> it = headsDragon.iterator();
    while(it.hasNext()){
      it.next().changeIteration(ii);
